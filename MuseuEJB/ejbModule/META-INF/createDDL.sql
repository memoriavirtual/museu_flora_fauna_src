...
CREATE TABLE POLIGONO (ID VARCHAR(255) NOT NULL, FORMA TEXT, NOME VARCHAR(255), MAPA_ID VARCHAR(255), PRIMARY KEY (ID));
CREATE TABLE MAPA (ID VARCHAR(255) NOT NULL, LATITUDE VARCHAR(255), LONGITUDE VARCHAR(255), TIPO VARCHAR(255), URL VARCHAR(255), PRIMARY KEY (ID));
