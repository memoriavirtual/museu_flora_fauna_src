...
CREATE TABLE SLIDE (ID VARCHAR(255) NOT NULL, CONTENT BYTEA, CONTENTTYPE VARCHAR(255), LINK VARCHAR(255), ORDEM INTEGER, TEXTO VARCHAR(650), TITULO VARCHAR(255), CONFIGURACAO_ID VARCHAR(255), PRIMARY KEY (ID));
...
CREATE TABLE POLIGONO (ID VARCHAR(255) NOT NULL, FORMA VARCHAR(255), NOME VARCHAR(255), MAPA_ID VARCHAR(255), PRIMARY KEY (ID));
CREATE TABLE MAPA (ID VARCHAR(255) NOT NULL, LATCENTER BIGINT, LONGCENTER BIGINT, TIPO VARCHAR(255), ZOOMLEVELS VARCHAR(255), PRIMARY KEY (ID));
ALTER TABLE POLIGONO ADD CONSTRAINT FK_POLIGONO_MAPA_ID FOREIGN KEY (MAPA_ID) REFERENCES MAPA (ID);
CREATE SEQUENCE MAPA_SEQ START WITH 1;
CREATE SEQUENCE POLIGONO_SEQ START WITH 1;
