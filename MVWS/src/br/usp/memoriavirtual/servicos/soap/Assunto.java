...
public class Assunto  implements java.io.Serializable {
    ...
    /**
     * Gets the assunto value for this Assunto.
     * 
     * @return assunto
     */
    ...
    /**
     * Sets the assunto value for this Assunto.
     * 
     * @param assunto
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soap.servicos.memoriavirtual.usp.br/", "assunto"));
